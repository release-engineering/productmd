...
project = u'productmd'
copyright = u'Copyright (C) 2015  Red Hat, Inc.'
...
latex_documents = [
  ('index', 'productmd.tex', u'productmd Documentation',
   u'Daniel Mach <dmach@redhat.com>', 'manual'),
]
...
man_pages = [
    # docs
    ('terminology', 'productmd-terminology', u'productmd Documentation',
...
texinfo_documents = [
  ('index', 'productmd', u'productmd Documentation',
   u'Daniel Mach <dmach@redhat.com>', 'productmd', 'One line description of project.',
   'Miscellaneous'),
]
